...
![opensource](https://img.shields.io/badge/opensource-yes-8a2be2.svg?style=flat-square) ![Last Commit](https://img.shields.io/badge/last%20commit-january%202026-9acd32.svg?style=flat-square)
...
- **`internal/`**: Private application code.
    - **`adapters/`**: implementations of interfaces for external services.
